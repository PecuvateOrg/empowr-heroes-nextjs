...
function FooterSection({ heading, children }: { heading: string; children: React.ReactNode }) {
  const [open, setOpen] = useState(false)
  return (
    <div className={`footer-section${open ? ' footer-section--open' : ''}`}>
      <button
  ...
  return (
    <footer className="site-footer">
      <div className="footer-grid">
        ...
        <FooterSection heading="Find Us">
          <div className="footer-social">
            <a href={LINKS.social.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram">
              <InstagramIcon />
            </a>
